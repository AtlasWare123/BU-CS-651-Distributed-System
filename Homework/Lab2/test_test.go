...
func TestInitialElection2A(t *testing.T) {
	...
	// is a leader elected?
	DPrintf("The number of servers %d", cfg.n)
	cfg.checkOneLeader()
	...
	if term1 != term2 {
		DPrintf("Term1 is %v, Term2 is %v", term1, term2)
...
func TestBasicAgree2B(t *testing.T) {
	...
	for index := 1; index < iters+1; index++ {
		nd, _ := cfg.nCommitted(index) // how many servers think a log entry is committed? nd is count of how many servers believe a log entry is committed.
		if nd > 0 {
			fmt.Printf("Over HERE...............................................")
...
func TestFailAgree2B(t *testing.T) {
	...
	fmt.Printf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX      leader = %v, disconnect = %v    XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX \n", leader, (leader+1)%servers)

	// agree despite one failed server?
	fmt.Printf("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<102 START>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n\n")
	cfg.one(102, servers-1)
	fmt.Printf("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<102 END>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> \n\n")
	fmt.Printf("<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<103 START>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>\n\n")
	...
	fmt.Printf("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX      leader = %v, reconnect = %v    XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX \n", leader, (leader+1)%servers)
